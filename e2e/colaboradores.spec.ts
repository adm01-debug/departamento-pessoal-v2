...
test.describe("colaboradores E2E Tests", () => {
  ...
  test("should navigate to colaboradores", async ({ page }) => {
    await page.click("[data-testid='nav-colaboradores']");
    await expect(page.locator("h1")).toBeVisible();
  });

  test("should display colaboradores content", async ({ page }) => {
    await page.goto("/colaboradores");
    await expect(page.locator("main")).toBeVisible();
  });

  test("should handle colaboradores interactions", async ({ page }) => {
    await page.goto("/colaboradores");
