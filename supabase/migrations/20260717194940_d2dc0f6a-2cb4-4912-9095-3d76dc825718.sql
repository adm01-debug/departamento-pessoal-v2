...
CREATE TABLE public.epis_fichas (
...
CREATE INDEX idx_epis_fichas_empresa ON public.epis_fichas(empresa_id);
CREATE INDEX idx_epis_fichas_colab ON public.epis_fichas(colaborador_id);
CREATE INDEX idx_epis_fichas_status ON public.epis_fichas(empresa_id, status);
...
-- Itens da ficha
CREATE TABLE public.epis_fichas_itens (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE INDEX idx_epis_itens_ficha ON public.epis_fichas_itens(ficha_id);
CREATE INDEX idx_epis_itens_status ON public.epis_fichas_itens(status_item);
...
CREATE TABLE public.epis_fichas_assinaturas (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
