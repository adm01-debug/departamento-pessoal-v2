...
DROP POLICY IF EXISTS "Colaboradores podem fazer upload de suas fotos de ponto" ON public.storage;
...
DROP POLICY IF EXISTS "Colaboradores podem ver suas próprias fotos de ponto" ON public.storage;
...
DROP POLICY IF EXISTS "Gestores podem ver fotos de ponto da empresa" ON public.storage;
