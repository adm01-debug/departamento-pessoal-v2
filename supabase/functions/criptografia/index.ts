...
import { corsHeadersObj, corsHeaders, createErrorResponse, createValidationErrorResponse } from '../_shared/contract.ts';
    ...
    switch (body.action) {
      ...
      case 'decrypt': {
        try {
          ...
          return createErrorResponse('Falha ao descriptografar', 400, 'DECRYPT_FAILED', undefined, req);
        }
      }
