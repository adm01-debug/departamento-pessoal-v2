...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!compCheck.ok) {
      return createErrorResponse(compCheck.msg!, 422, 'INVALID_COMPETENCIA', undefined, req);
    }
    ...
    return createErrorResponse('Erro ao gerar DCTFWeb', 500, 'INTERNAL_ERROR', undefined, req);
  }
});
