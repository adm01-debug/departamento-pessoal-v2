...
const ALLOWED_BUCKETS = new Set(['documentos', 'colaboradores', 'documents', 'arquivos', 'uploads', 'documentos-admissao']);
...
serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    try { captureException(error as Error, { fn: 'OCR' }); } catch { /* noop */ }
