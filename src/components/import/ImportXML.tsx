...
interface ImportXMLProps { onImport?: (data: any[]) => void; accept?: string; maxSize?: number; }

export function ImportXML({ onImport, accept = ".csv,.xlsx", maxSize = 5 }: ImportXMLProps) {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><Upload className="h-5 w-5" />ImportXML</CardTitle></CardHeader>
