...
interface ImportCSVProps { onImport?: (data: any[]) => void; accept?: string; maxSize?: number; }

export function ImportCSV({ onImport, accept = ".csv,.xlsx", maxSize = 5 }: ImportCSVProps) {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><Upload className="h-5 w-5" />ImportCSV</CardTitle></CardHeader>
