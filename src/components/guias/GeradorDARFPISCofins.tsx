...
export const GeradorDARFPISCofins: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />DARF PIS/COFINS</CardTitle>
        <CardDescription>Contribuições sobre faturamento</CardDescription>
      </CardHeader>
...
export default GeradorDARFPISCofins;
