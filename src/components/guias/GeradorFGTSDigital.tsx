...
export const GeradorFGTSDigital: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />FGTS Digital</CardTitle>
        <CardDescription>Recolhimento FGTS via PIX</CardDescription>
      </CardHeader>
...
export default GeradorFGTSDigital;
