...
interface GuiaFGTSGeneratorProps {
  data?: any;
  onGenerate?: () => void;
  onPrint?: () => void;
  onDownload?: () => void;
...
export const GuiaFGTSGenerator: React.FC<GuiaFGTSGeneratorProps> = ({ data, onGenerate, onPrint, onDownload }) => {
...
export default GuiaFGTSGenerator;
