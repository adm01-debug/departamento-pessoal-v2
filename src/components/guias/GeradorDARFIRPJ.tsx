...
export const GeradorDARFIRPJ: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />DARF IRPJ</CardTitle>
        <CardDescription>Imposto de Renda Pessoa Jurídica</CardDescription>
      </CardHeader>
...
export default GeradorDARFIRPJ;
