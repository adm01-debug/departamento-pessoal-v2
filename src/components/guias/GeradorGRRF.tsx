...
export const GeradorGRRF: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />GRRF</CardTitle>
        <CardDescription>Guia de Recolhimento Rescisório do FGTS</CardDescription>
      </CardHeader>
