...
export const GROEditor: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Shield className="h-5 w-5" />GRO - Gerenciamento de Riscos Ocupacionais<Badge variant={status === 'vigente' ? 'default' : status === 'vencido' ? 'destructive' : 'outline'}>{status}</Badge></CardTitle>
        <CardDescription>Gestão integrada de riscos ocupacionais</CardDescription>
      </CardHeader>
