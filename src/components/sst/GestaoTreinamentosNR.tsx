...
export const GestaoTreinamentosNR: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Shield className="h-5 w-5" />Treinamentos NR<Badge variant={status === 'vigente' ? 'default' : status === 'vencido' ? 'destructive' : 'outline'}>{status}</Badge></CardTitle>
        <CardDescription>Gestão de treinamentos obrigatórios</CardDescription>
      </CardHeader>
...
export default GestaoTreinamentosNR;
