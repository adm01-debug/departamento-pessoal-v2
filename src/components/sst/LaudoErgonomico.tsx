...
export const LaudoErgonomico: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Shield className="h-5 w-5" />Laudo Ergonômico<Badge variant={status === 'vigente' ? 'default' : status === 'vencido' ? 'destructive' : 'outline'}>{status}</Badge></CardTitle>
        <CardDescription>Análise Ergonômica do Trabalho - AET</CardDescription>
      </CardHeader>
...
export default LaudoErgonomico;
