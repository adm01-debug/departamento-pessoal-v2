...
export const ECD: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileSpreadsheet className="h-5 w-5" />ECD<Badge variant={status === 'transmitida' ? 'default' : 'outline'}>{status}</Badge></CardTitle>
        <CardDescription>Escrituração Contábil Digital</CardDescription>
      </CardHeader>
