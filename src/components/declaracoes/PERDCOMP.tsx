...
export const PERDCOMP: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileSpreadsheet className="h-5 w-5" />PERDCOMP<Badge variant={status === 'transmitida' ? 'default' : 'outline'}>{status}</Badge></CardTitle>
        <CardDescription>Pedido de Restituição, Ressarcimento ou Compensação</CardDescription>
      </CardHeader>
