...
export const DEFIS: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileSpreadsheet className="h-5 w-5" />DEFIS<Badge variant={status === 'transmitida' ? 'default' : 'outline'}>{status}</Badge></CardTitle>
        <CardDescription>Declaração de Informações Socioeconômicas e Fiscais</CardDescription>
      </CardHeader>
