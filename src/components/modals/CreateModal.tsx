...
interface CreateModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function CreateModal({ open, onOpenChange, data, onConfirm, title = "CreateModal", loading = false }: CreateModalProps) {
  return (
