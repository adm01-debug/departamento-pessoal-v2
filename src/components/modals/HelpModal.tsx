...
interface HelpModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function HelpModal({ open, onOpenChange, data, onConfirm, title = "HelpModal", loading = false }: HelpModalProps) {
  return (
