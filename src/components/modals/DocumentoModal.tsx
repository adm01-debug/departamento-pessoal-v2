...
interface DocumentoModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function DocumentoModal({ open, onOpenChange, data, onConfirm, title = "DocumentoModal", loading = false }: DocumentoModalProps) {
  return (
