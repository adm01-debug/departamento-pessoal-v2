...
interface ShareModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function ShareModal({ open, onOpenChange, data, onConfirm, title = "ShareModal", loading = false }: ShareModalProps) {
  return (
