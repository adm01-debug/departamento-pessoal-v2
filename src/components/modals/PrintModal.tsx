...
interface PrintModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function PrintModal({ open, onOpenChange, data, onConfirm, title = "PrintModal", loading = false }: PrintModalProps) {
  return (
