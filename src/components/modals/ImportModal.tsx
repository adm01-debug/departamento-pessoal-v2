...
interface ImportModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function ImportModal({ open, onOpenChange, data, onConfirm, title = "ImportModal", loading = false }: ImportModalProps) {
  return (
