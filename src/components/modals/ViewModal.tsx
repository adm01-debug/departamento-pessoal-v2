...
interface ViewModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function ViewModal({ open, onOpenChange, data, onConfirm, title = "ViewModal", loading = false }: ViewModalProps) {
  return (
