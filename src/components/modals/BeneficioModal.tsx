...
interface BeneficioModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function BeneficioModal({ open, onOpenChange, data, onConfirm, title = "BeneficioModal", loading = false }: BeneficioModalProps) {
  return (
