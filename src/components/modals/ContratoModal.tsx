...
interface ContratoModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function ContratoModal({ open, onOpenChange, data, onConfirm, title = "ContratoModal", loading = false }: ContratoModalProps) {
  return (
