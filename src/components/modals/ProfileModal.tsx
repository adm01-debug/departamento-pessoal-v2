...
interface ProfileModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function ProfileModal({ open, onOpenChange, data, onConfirm, title = "ProfileModal", loading = false }: ProfileModalProps) {
  return (
