...
interface EditModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function EditModal({ open, onOpenChange, data, onConfirm, title = "EditModal", loading = false }: EditModalProps) {
  return (
