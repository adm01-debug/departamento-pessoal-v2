...
interface SearchModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function SearchModal({ open, onOpenChange, data, onConfirm, title = "SearchModal", loading = false }: SearchModalProps) {
  return (
