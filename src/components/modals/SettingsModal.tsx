...
interface SettingsModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function SettingsModal({ open, onOpenChange, data, onConfirm, title = "SettingsModal", loading = false }: SettingsModalProps) {
  return (
