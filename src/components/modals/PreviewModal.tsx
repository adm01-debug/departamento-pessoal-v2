...
interface PreviewModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function PreviewModal({ open, onOpenChange, data, onConfirm, title = "PreviewModal", loading = false }: PreviewModalProps) {
  return (
