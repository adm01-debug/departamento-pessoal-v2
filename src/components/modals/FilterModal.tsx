...
interface FilterModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function FilterModal({ open, onOpenChange, data, onConfirm, title = "FilterModal", loading = false }: FilterModalProps) {
  return (
