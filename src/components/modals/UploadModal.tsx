...
interface UploadModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function UploadModal({ open, onOpenChange, data, onConfirm, title = "UploadModal", loading = false }: UploadModalProps) {
  return (
