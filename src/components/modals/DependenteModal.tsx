...
interface DependenteModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function DependenteModal({ open, onOpenChange, data, onConfirm, title = "DependenteModal", loading = false }: DependenteModalProps) {
  return (
