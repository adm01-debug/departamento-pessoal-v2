...
interface EmpresaModalProps { open: boolean; onOpenChange: (open: boolean) => void; data?: any; onConfirm?: (data?: any) => void; title?: string; loading?: boolean; }

export function EmpresaModal({ open, onOpenChange, data, onConfirm, title = "EmpresaModal", loading = false }: EmpresaModalProps) {
  return (
