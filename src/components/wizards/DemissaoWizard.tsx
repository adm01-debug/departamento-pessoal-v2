...
interface DemissaoWizardProps { onComplete?: (data: any) => void; onCancel?: () => void; }

export const DemissaoWizard: React.FC<DemissaoWizardProps> = ({ onComplete, onCancel }) => {
  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle>Demissão - Passo {step} de {totalSteps}</CardTitle>
