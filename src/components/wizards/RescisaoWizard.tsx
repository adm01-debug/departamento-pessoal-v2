...
interface RescisaoWizardProps { onComplete?: (data: any) => void; onCancel?: () => void; }

export const RescisaoWizard: React.FC<RescisaoWizardProps> = ({ onComplete, onCancel }) => {
  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle>Rescisão - Passo {step} de {totalSteps}</CardTitle>
