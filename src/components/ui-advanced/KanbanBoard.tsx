...
export interface KanbanBoardProps extends React.HTMLAttributes<HTMLDivElement> { variant?: "default" | "outline" | "ghost"; size?: "sm" | "md" | "lg"; disabled?: boolean; }
const KanbanBoard = React.forwardRef<HTMLDivElement, KanbanBoardProps>(({ className, variant = "default", size = "md", disabled = false, children, ...props }, ref) => {
