...
export interface ContextMenuProps extends React.HTMLAttributes<HTMLDivElement> { variant?: "default" | "outline" | "ghost"; size?: "sm" | "md" | "lg"; disabled?: boolean; }
const ContextMenu = React.forwardRef<HTMLDivElement, ContextMenuProps>(({ className, variant = "default", size = "md", disabled = false, children, ...props }, ref) => {
