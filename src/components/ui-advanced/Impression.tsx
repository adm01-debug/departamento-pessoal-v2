...
export interface ImpressionProps extends React.HTMLAttributes<HTMLDivElement> { variant?: "default" | "outline" | "ghost"; size?: "sm" | "md" | "lg"; disabled?: boolean; }
const Impression = React.forwardRef<HTMLDivElement, ImpressionProps>(({ className, variant = "default", size = "md", disabled = false, children, ...props }, ref) => {
...
Impression.displayName = "Impression";
export { Impression };
