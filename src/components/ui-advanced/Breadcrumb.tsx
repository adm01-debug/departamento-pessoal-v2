...
export interface BreadcrumbProps extends React.HTMLAttributes<HTMLDivElement> { variant?: "default" | "outline" | "ghost"; size?: "sm" | "md" | "lg"; disabled?: boolean; }
const Breadcrumb = React.forwardRef<HTMLDivElement, BreadcrumbProps>(({ className, variant = "default", size = "md", disabled = false, children, ...props }, ref) => {
