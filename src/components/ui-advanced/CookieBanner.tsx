...
export interface CookieBannerProps extends React.HTMLAttributes<HTMLDivElement> { variant?: "default" | "outline" | "ghost"; size?: "sm" | "md" | "lg"; disabled?: boolean; }
const CookieBanner = React.forwardRef<HTMLDivElement, CookieBannerProps>(({ className, variant = "default", size = "md", disabled = false, children, ...props }, ref) => {
