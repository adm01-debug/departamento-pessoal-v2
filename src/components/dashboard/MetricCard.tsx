...
interface MetricCardProps { className?: string; title?: string; value?: number | string; data?: any[]; loading?: boolean; }

export function MetricCard({ className, title = "MetricCard", value, data = [], loading = false }: MetricCardProps) {
