...
interface AbsenteismChartProps { className?: string; title?: string; value?: number | string; data?: any[]; loading?: boolean; }

export function AbsenteismChart({ className, title = "AbsenteismChart", value, data = [], loading = false }: AbsenteismChartProps) {
