...
interface PendingApprovalsCardProps { className?: string; title?: string; value?: number | string; data?: any[]; loading?: boolean; }

export function PendingApprovalsCard({ className, title = "PendingApprovalsCard", value, data = [], loading = false }: PendingApprovalsCardProps) {
