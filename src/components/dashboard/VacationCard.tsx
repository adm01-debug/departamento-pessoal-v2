...
interface VacationCardProps { className?: string; title?: string; value?: number | string; data?: any[]; loading?: boolean; }

export function VacationCard({ className, title = "VacationCard", value, data = [], loading = false }: VacationCardProps) {
