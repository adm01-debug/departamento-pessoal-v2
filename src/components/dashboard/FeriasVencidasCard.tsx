...
interface FeriasVencidasCardProps { className?: string; title?: string; value?: number | string; data?: any[]; loading?: boolean; }

export function FeriasVencidasCard({ className, title = "FeriasVencidasCard", value, data = [], loading = false }: FeriasVencidasCardProps) {
...
export default FeriasVencidasCard;
