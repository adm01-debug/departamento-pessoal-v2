...
interface SimuladorEncargosProps { onCalculate?: (result: any) => void; }

export const SimuladorEncargos: React.FC<SimuladorEncargosProps> = ({ onCalculate }) => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Simulador de Encargos</CardTitle></CardHeader>
...
export default SimuladorEncargos;
