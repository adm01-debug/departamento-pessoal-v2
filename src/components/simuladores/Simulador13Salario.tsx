...
interface Simulador13SalarioProps { onCalculate?: (result: any) => void; }

export const Simulador13Salario: React.FC<Simulador13SalarioProps> = ({ onCalculate }) => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Simulador 13º Salário</CardTitle></CardHeader>
...
export default Simulador13Salario;
