...
interface SimuladorAumentoProps { onCalculate?: (result: any) => void; }

export const SimuladorAumento: React.FC<SimuladorAumentoProps> = ({ onCalculate }) => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Simulador de Aumento</CardTitle></CardHeader>
...
export default SimuladorAumento;
