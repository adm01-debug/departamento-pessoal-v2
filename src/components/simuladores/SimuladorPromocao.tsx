...
interface SimuladorPromocaoProps { onCalculate?: (result: any) => void; }

export const SimuladorPromocao: React.FC<SimuladorPromocaoProps> = ({ onCalculate }) => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Simulador de Promoção</CardTitle></CardHeader>
