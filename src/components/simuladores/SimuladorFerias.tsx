...
interface SimuladorFeriasProps { onCalculate?: (result: any) => void; }

export const SimuladorFerias: React.FC<SimuladorFeriasProps> = ({ onCalculate }) => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Simulador de Férias</CardTitle></CardHeader>
...
export default SimuladorFerias;
