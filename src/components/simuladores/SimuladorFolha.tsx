...
interface SimuladorFolhaProps { onCalculate?: (result: any) => void; }

export const SimuladorFolha: React.FC<SimuladorFolhaProps> = ({ onCalculate }) => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Simulador de Folha</CardTitle></CardHeader>
