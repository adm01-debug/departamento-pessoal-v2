...
interface CalendarioEscalasProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function CalendarioEscalas({ className, events = [], onDateSelect }: CalendarioEscalasProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>CalendarioEscalas</CardTitle></CardHeader>
