...
interface CalendarioAdmissoesProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function CalendarioAdmissoes({ className, events = [], onDateSelect }: CalendarioAdmissoesProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>CalendarioAdmissoes</CardTitle></CardHeader>
...
export default CalendarioAdmissoes;
