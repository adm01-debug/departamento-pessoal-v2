...
interface AgendaRHProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function AgendaRH({ className, events = [], onDateSelect }: AgendaRHProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>AgendaRH</CardTitle></CardHeader>
