...
interface CalendarioVencimentosProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function CalendarioVencimentos({ className, events = [], onDateSelect }: CalendarioVencimentosProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>CalendarioVencimentos</CardTitle></CardHeader>
