...
interface CalendarioFeriasProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function CalendarioFerias({ className, events = [], onDateSelect }: CalendarioFeriasProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>CalendarioFerias</CardTitle></CardHeader>
