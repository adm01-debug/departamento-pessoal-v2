...
interface CalendarioFeriadosProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function CalendarioFeriados({ className, events = [], onDateSelect }: CalendarioFeriadosProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>CalendarioFeriados</CardTitle></CardHeader>
