...
interface AgendaEventosProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function AgendaEventos({ className, events = [], onDateSelect }: AgendaEventosProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>AgendaEventos</CardTitle></CardHeader>
