...
interface CalendarioDemissoesProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function CalendarioDemissoes({ className, events = [], onDateSelect }: CalendarioDemissoesProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>CalendarioDemissoes</CardTitle></CardHeader>
...
export default CalendarioDemissoes;
