...
interface CalendarioExamesProps { className?: string; events?: Array<{ date: Date; title: string; type: string }>; onDateSelect?: (date: Date) => void; }

export function CalendarioExames({ className, events = [], onDateSelect }: CalendarioExamesProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader><CardTitle>CalendarioExames</CardTitle></CardHeader>
