...
interface AccessibleSliderProps extends React.HTMLAttributes<HTMLDivElement> {
  label?: string;
  description?: string;
  error?: string;
}
 ...
 */
export const AccessibleSlider = forwardRef<HTMLDivElement, AccessibleSliderProps>(
