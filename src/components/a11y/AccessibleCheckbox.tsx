...
interface AccessibleCheckboxProps extends React.HTMLAttributes<HTMLDivElement> {
  label?: string;
  description?: string;
  error?: string;
}
 ...
 */
export const AccessibleCheckbox = forwardRef<HTMLDivElement, AccessibleCheckboxProps>(
