...
interface AccessibleSwitchProps extends React.HTMLAttributes<HTMLDivElement> {
  label?: string;
  description?: string;
  error?: string;
}
 ...
 */
export const AccessibleSwitch = forwardRef<HTMLDivElement, AccessibleSwitchProps>(
