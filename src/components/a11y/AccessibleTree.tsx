...
interface AccessibleTreeProps extends React.HTMLAttributes<HTMLDivElement> {
  label?: string;
  description?: string;
  error?: string;
}
 ...
 */
export const AccessibleTree = forwardRef<HTMLDivElement, AccessibleTreeProps>(
...
AccessibleTree.displayName = 'AccessibleTree';
export default AccessibleTree;
