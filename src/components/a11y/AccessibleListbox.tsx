...
interface AccessibleListboxProps extends React.HTMLAttributes<HTMLDivElement> {
  label?: string;
  description?: string;
  error?: string;
}
 ...
 */
export const AccessibleListbox = forwardRef<HTMLDivElement, AccessibleListboxProps>(
