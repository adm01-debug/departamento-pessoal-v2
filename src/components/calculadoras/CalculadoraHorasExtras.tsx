...
interface CalculadoraHorasExtrasProps { onCalculate?: (result: any) => void; }

export const CalculadoraHorasExtras: React.FC<CalculadoraHorasExtrasProps> = ({ onCalculate }) => {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Calculator className="w-5 h-5" />Calculadora Horas Extras
        </CardTitle>
      </CardHeader>
