...
interface CalculadoraDSRProps { onCalculate?: (result: any) => void; }

export const CalculadoraDSR: React.FC<CalculadoraDSRProps> = ({ onCalculate }) => {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Calculator className="w-5 h-5" />Calculadora DSR
        </CardTitle>
      </CardHeader>
