...
interface CalculadoraBancoHorasProps { onCalculate?: (result: any) => void; }

export const CalculadoraBancoHoras: React.FC<CalculadoraBancoHorasProps> = ({ onCalculate }) => {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Calculator className="w-5 h-5" />Calculadora Banco de Horas
        </CardTitle>
      </CardHeader>
