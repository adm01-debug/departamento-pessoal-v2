...
interface CalculadoraFGTSProps { onCalculate?: (result: any) => void; }

export const CalculadoraFGTS: React.FC<CalculadoraFGTSProps> = ({ onCalculate }) => {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Calculator className="w-5 h-5" />Calculadora FGTS
        </CardTitle>
      </CardHeader>
