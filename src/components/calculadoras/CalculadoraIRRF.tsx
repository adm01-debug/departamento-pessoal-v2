...
interface CalculadoraIRRFProps { onCalculate?: (result: any) => void; }

export const CalculadoraIRRF: React.FC<CalculadoraIRRFProps> = ({ onCalculate }) => {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Calculator className="w-5 h-5" />Calculadora IRRF
        </CardTitle>
      </CardHeader>
