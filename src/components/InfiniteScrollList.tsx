...
export function InfiniteScrollList<T>({ items, renderItem, isLoading, isFetchingNextPage, hasNextPage, setLoadMoreRef, emptyMessage = 'Nenhum item encontrado', className }: InfiniteScrollListProps<T>) {
