...
interface SeguroDesempregoCalcProps {
  data?: any;
  onGenerate?: () => void;
  onPrint?: () => void;
  onDownload?: () => void;
...
export const SeguroDesempregoCalc: React.FC<SeguroDesempregoCalcProps> = ({ data, onGenerate, onPrint, onDownload }) => {
...
export default SeguroDesempregoCalc;
