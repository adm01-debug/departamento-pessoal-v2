...
interface ReciboRescisaoGeneratorProps {
  data?: any;
  onGenerate?: () => void;
  onPrint?: () => void;
  onDownload?: () => void;
...
export const ReciboRescisaoGenerator: React.FC<ReciboRescisaoGeneratorProps> = ({ data, onGenerate, onPrint, onDownload }) => {
