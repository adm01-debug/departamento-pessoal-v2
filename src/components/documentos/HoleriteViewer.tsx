...
interface HoleriteViewerProps { className?: string; data?: any; onAction?: (action: string, data?: any) => void; loading?: boolean; }

export function HoleriteViewer({ className, data, onAction, loading }: HoleriteViewerProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />HoleriteViewer</CardTitle>
      </CardHeader>
