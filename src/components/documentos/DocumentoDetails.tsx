...
interface DocumentoDetailsProps { className?: string; data?: any; onAction?: (action: string, data?: any) => void; loading?: boolean; }

export function DocumentoDetails({ className, data, onAction, loading }: DocumentoDetailsProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />DocumentoDetails</CardTitle>
      </CardHeader>
