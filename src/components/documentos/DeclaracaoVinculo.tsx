...
interface DeclaracaoVinculoProps { className?: string; data?: any; onAction?: (action: string, data?: any) => void; loading?: boolean; }

export function DeclaracaoVinculo({ className, data, onAction, loading }: DeclaracaoVinculoProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />DeclaracaoVinculo</CardTitle>
      </CardHeader>
...
export default DeclaracaoVinculo;
