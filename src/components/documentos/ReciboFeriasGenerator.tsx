...
interface ReciboFeriasGeneratorProps {
  data?: any;
  onGenerate?: () => void;
  onPrint?: () => void;
  onDownload?: () => void;
...
export const ReciboFeriasGenerator: React.FC<ReciboFeriasGeneratorProps> = ({ data, onGenerate, onPrint, onDownload }) => {
