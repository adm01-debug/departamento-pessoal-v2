...
interface ReciboFeriasGeneratorProps { className?: string; data?: any; onAction?: (action: string, data?: any) => void; loading?: boolean; }

export function ReciboFeriasGenerator({ className, data, onAction, loading }: ReciboFeriasGeneratorProps) {
  ...
  return (
    <Card className={cn("", className)}>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />ReciboFeriasGenerator</CardTitle>
      </CardHeader>
...
export default ReciboFeriasGenerator;
