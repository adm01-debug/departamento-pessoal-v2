...
export const S2190RegistroPreliminar: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />S-2190 - Registro Preliminar de Trabalhador<Badge variant="outline">{status}</Badge></CardTitle></CardHeader>
      <CardContent className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Evento S-2190 - Registro Preliminar de Trabalhador - preencha os campos obrigatórios</p>
...
export default S2190RegistroPreliminar;
