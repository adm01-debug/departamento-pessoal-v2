...
export const S1298Reabertura: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />S-1298 - Reabertura dos Eventos Periódicos<Badge variant="outline">{status}</Badge></CardTitle></CardHeader>
      <CardContent className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Evento S-1298 - Reabertura dos Eventos Periódicos - preencha os campos obrigatórios</p>
...
export default S1298Reabertura;
