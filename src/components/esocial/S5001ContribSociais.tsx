...
export const S5001ContribSociais: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />S-5001 - Informações das Contrib. Sociais por Trabalhador<Badge variant="outline">{status}</Badge></CardTitle></CardHeader>
      <CardContent className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Evento S-5001 - Informações das Contrib. Sociais por Trabalhador - preencha os campos obrigatórios</p>
...
export default S5001ContribSociais;
