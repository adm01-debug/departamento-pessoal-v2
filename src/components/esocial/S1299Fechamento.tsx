...
export const S1299Fechamento: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />S-1299 - Fechamento dos Eventos Periódicos<Badge variant="outline">{status}</Badge></CardTitle></CardHeader>
      <CardContent className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Evento S-1299 - Fechamento dos Eventos Periódicos - preencha os campos obrigatórios</p>
...
export default S1299Fechamento;
