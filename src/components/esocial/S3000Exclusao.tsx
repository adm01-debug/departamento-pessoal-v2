...
export const S3000Exclusao: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />S-3000 - Exclusão de Eventos<Badge variant="outline">{status}</Badge></CardTitle></CardHeader>
      <CardContent className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Evento S-3000 - Exclusão de Eventos - preencha os campos obrigatórios</p>
