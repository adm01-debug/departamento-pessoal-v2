...
interface ESocialListProps { title?: string; status?: "pendente" | "enviado" | "aceito" | "rejeitado"; data?: any; className?: string; }
export function ESocialList({ title = "ESocialList", status = "pendente", data, className }: ESocialListProps) {
