...
export const S2210CAT: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />S-2210 - Comunicação de Acidente de Trabalho<Badge variant="outline">{status}</Badge></CardTitle></CardHeader>
      <CardContent className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">Evento S-2210 - Comunicação de Acidente de Trabalho - preencha os campos obrigatórios</p>
