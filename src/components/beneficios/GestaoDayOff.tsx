...
export const GestaoDayOff: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Day Off</CardTitle>
        <CardDescription>Gestão de folgas de aniversário</CardDescription>
      </CardHeader>
