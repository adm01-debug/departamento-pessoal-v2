...
export const GestaoSeguroVidaGrupo: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Seguro de Vida em Grupo</CardTitle>
        <CardDescription>Apólices de seguro de vida</CardDescription>
      </CardHeader>
...
export default GestaoSeguroVidaGrupo;
