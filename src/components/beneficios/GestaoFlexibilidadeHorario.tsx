...
export const GestaoFlexibilidadeHorario: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Flexibilidade de Horário</CardTitle>
        <CardDescription>Gestão de horários flexíveis</CardDescription>
      </CardHeader>
...
export default GestaoFlexibilidadeHorario;
