...
export const GestaoCestaBasica: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Cesta Básica</CardTitle>
        <CardDescription>Gestão de cestas básicas para colaboradores</CardDescription>
      </CardHeader>
...
export default GestaoCestaBasica;
