...
export const GestaoPrevidenciaPrivada: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Previdência Privada</CardTitle>
        <CardDescription>Planos de previdência complementar</CardDescription>
      </CardHeader>
...
export default GestaoPrevidenciaPrivada;
