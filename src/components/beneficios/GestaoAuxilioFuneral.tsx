...
export const GestaoAuxilioFuneral: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Auxílio Funeral</CardTitle>
        <CardDescription>Assistência para despesas funerárias</CardDescription>
      </CardHeader>
...
export default GestaoAuxilioFuneral;
