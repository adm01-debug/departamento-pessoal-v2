...
export const GestaoHomeOffice: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Home Office</CardTitle>
        <CardDescription>Políticas e auxílio home office</CardDescription>
      </CardHeader>
...
export default GestaoHomeOffice;
