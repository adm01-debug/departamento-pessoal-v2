...
export const GestaoPlanoOdontologico: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Plano Odontológico</CardTitle>
        <CardDescription>Gestão de planos odontológicos</CardDescription>
      </CardHeader>
...
export default GestaoPlanoOdontologico;
