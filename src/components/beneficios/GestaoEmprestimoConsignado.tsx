...
export const GestaoEmprestimoConsignado: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Empréstimo Consignado</CardTitle>
        <CardDescription>Controle de consignações em folha</CardDescription>
      </CardHeader>
...
export default GestaoEmprestimoConsignado;
