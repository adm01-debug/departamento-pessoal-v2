...
export const GestaoAuxilioEducacao: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Auxílio Educação</CardTitle>
        <CardDescription>Bolsas de estudo e reembolso educacional</CardDescription>
      </CardHeader>
...
export default GestaoAuxilioEducacao;
