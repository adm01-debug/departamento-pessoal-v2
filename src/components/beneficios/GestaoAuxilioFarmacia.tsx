...
export const GestaoAuxilioFarmacia: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Auxílio Farmácia</CardTitle>
        <CardDescription>Desconto e reembolso em medicamentos</CardDescription>
      </CardHeader>
...
export default GestaoAuxilioFarmacia;
