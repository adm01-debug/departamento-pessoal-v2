...
export const GestaoStockOptions: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Stock Options</CardTitle>
        <CardDescription>Planos de opção de compra de ações</CardDescription>
      </CardHeader>
...
export default GestaoStockOptions;
