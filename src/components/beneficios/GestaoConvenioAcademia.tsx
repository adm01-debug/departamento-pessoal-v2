...
export const GestaoConvenioAcademia: React.FC = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><Gift className="h-5 w-5" />Convênio Academia</CardTitle>
        <CardDescription>Parcerias com academias e wellness</CardDescription>
      </CardHeader>
...
export default GestaoConvenioAcademia;
