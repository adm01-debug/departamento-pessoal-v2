  ...
  return (
    <header className={cn(
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={onMenuClick} className="lg:hidden hover:bg-accent/50 rounded-xl">
        ...
        >
          ...
          <span className="text-sm font-body text-muted-foreground/60 w-52 text-left">Buscar...</span>
