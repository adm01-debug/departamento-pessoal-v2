...
export const RelatorioGFIP: React.FC = () => {
  ...
  const gerarRelatorio = async (formato: 'pdf' | 'excel') => {
    ...
    setLoading(false);
    console.log('Gerando GFIP - Guia de Recolhimento do FGTS em', formato);
  };

  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />GFIP - Guia de Recolhimento do FGTS</CardTitle>
        <CardDescription>Informações previdenciárias e FGTS</CardDescription>
      </CardHeader>
