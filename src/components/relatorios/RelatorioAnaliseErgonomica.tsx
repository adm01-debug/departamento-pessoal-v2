...
export const RelatorioAnaliseErgonomica: React.FC = () => {
  ...
  const gerarRelatorio = async (formato: 'pdf' | 'excel') => {
    ...
    setLoading(false);
    console.log('Gerando AET - Análise Ergonômica do Trabalho em', formato);
  };

  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />AET - Análise Ergonômica do Trabalho</CardTitle>
        <CardDescription>Avaliação ergonômica dos postos</CardDescription>
      </CardHeader>
...
export default RelatorioAnaliseErgonomica;
