...
export const RelatorioPCMSO: React.FC = () => {
  ...
  const gerarRelatorio = async (formato: 'pdf' | 'excel') => {
    ...
    setLoading(false);
    console.log('Gerando PCMSO - Programa de Controle Médico em', formato);
  };

  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />PCMSO - Programa de Controle Médico</CardTitle>
        <CardDescription>Saúde ocupacional dos trabalhadores</CardDescription>
      </CardHeader>
