...
export const RelatorioCaged: React.FC = () => {
  ...
  const gerarRelatorio = async (formato: 'pdf' | 'excel') => {
    ...
    setLoading(false);
    console.log('Gerando CAGED - Cadastro Geral de Empregados em', formato);
  };

  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />CAGED - Cadastro Geral de Empregados</CardTitle>
