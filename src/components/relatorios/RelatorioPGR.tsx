...
export const RelatorioPGR: React.FC = () => {
  ...
  const gerarRelatorio = async (formato: 'pdf' | 'excel') => {
    ...
    setLoading(false);
    console.log('Gerando PGR - Programa de Gerenciamento de Riscos em', formato);
  };

  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />PGR - Programa de Gerenciamento de Riscos</CardTitle>
        <CardDescription>Identificação e controle de riscos</CardDescription>
      </CardHeader>
