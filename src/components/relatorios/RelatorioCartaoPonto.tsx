...
export const RelatorioCartaoPonto: React.FC = () => {
  ...
  const gerarRelatorio = async (formato: 'pdf' | 'excel') => {
    ...
    setLoading(false);
    console.log('Gerando Cartão de Ponto em', formato);
  };

  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />Cartão de Ponto</CardTitle>
        <CardDescription>Resumo mensal de frequência</CardDescription>
      </CardHeader>
...
export default RelatorioCartaoPonto;
