class exportacaoServiceClass {
  async execute(params: any): Promise<any> { console.log("exportacaoService executed", params); return { success: true }; }
...
export const exportacaoService = new exportacaoServiceClass();
