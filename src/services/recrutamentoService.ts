...
export const recrutamentoService = {
  // ===== VAGAS =====
  async listarVagas(empresaId?: string): Promise<Result<any[]>> {
  ...
  async criarVaga(d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async atualizarVaga(id: string, d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async excluirVaga(id: string): Promise<Result<void>> {
    return toResult((async () => {
  ...
  // ===== CANDIDATOS =====
  async listarCandidatos(empresaId?: string): Promise<Result<any[]>> {
    return toResult((async () => {
  ...
  async criarCandidato(d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async atualizarCandidato(id: string, d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async excluirCandidato(id: string): Promise<Result<void>> {
    return toResult((async () => {
  ...
  // ===== CANDIDATURAS =====
  async listarCandidaturas(vagaId?: string): Promise<Result<any[]>> {
    return toResult((async () => {
  ...
  async criarCandidatura(d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async atualizarCandidatura(id: string, d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async excluirCandidatura(id: string): Promise<Result<void>> {
    return toResult((async () => {
  ...
  async agendarEntrevista(d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async registrarTeste(d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async adicionarAnotacao(d: Record<string, unknown>): Promise<Result<any>> {
    return toResult((async () => {
