...
export const turnoService = {
  async listarTurnos(empresaId?: string): Promise<Result<any[]>> {
  ...
  async criarTurno(d: any): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async atualizarTurno(id: string, d: any): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async excluirTurno(id: string): Promise<Result<void>> {
    return toResult((async () => {
  ...
  async listarEscalas(empresaId?: string, data?: string): Promise<Result<any[]>> {
    return toResult((async () => {
  ...
  async criarEscala(d: any): Promise<Result<any>> {
    return toResult((async () => {
  ...
  async excluirEscala(id: string): Promise<Result<void>> {
    return toResult((async () => {
