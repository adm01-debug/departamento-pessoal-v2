// notificacoesService - Service implementation
...
class ServiceImpl {
  ...
  async init(): Promise<ServiceResult> {
    ...
    console.log("[notificacoesService] Initializing...");
  ...
  async destroy(): Promise<ServiceResult> {
    console.log("[notificacoesService] Destroying...");
    this.initialized = false;
    return { success: true };
  }
}

export const notificacoesService = new ServiceImpl();
