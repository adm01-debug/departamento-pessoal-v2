class notificacaoServiceClass {
  async execute(params: any): Promise<any> { console.log("notificacaoService executed", params); return { success: true }; }
...
export const notificacaoService = new notificacaoServiceClass();
