...
describe('admissaoService',()=>{it('lista',async()=>{expect([]).toEqual([])});it('cria',async()=>{expect({id:'1'}).toBeDefined()});it('atualiza',async()=>{expect(true).toBe(true)});it('remove',async()=>{expect(true).toBe(true)})});
