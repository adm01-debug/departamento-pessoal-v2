// desligamentosService - Service implementation
...
class ServiceImpl {
  ...
  async init(): Promise<ServiceResult> {
    ...
    console.log("[desligamentosService] Initializing...");
  ...
  async destroy(): Promise<ServiceResult> {
    console.log("[desligamentosService] Destroying...");
    this.initialized = false;
    return { success: true };
  }
}

export const desligamentosService = new ServiceImpl();
export default desligamentosService;
