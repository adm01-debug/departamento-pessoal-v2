...
describe('AdmissaoChecklistModal', () => {
  ...
  it('renders correctly', () => {
    render(<AdmissaoChecklistModal isOpen={true} onClose={mockOnClose} />);
  ...
  it('submits form data', async () => {
    render(<AdmissaoChecklistModal isOpen={true} onClose={mockOnClose} onSubmit={mockOnSubmit} />);
  ...
  it('handles loading state', () => {
    render(<AdmissaoChecklistModal isOpen={true} onClose={mockOnClose} isLoading />);
