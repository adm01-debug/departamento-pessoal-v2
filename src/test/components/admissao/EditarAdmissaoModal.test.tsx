...
describe('EditarAdmissaoModal', () => {
  ...
  it('renders correctly', () => {
    render(<EditarAdmissaoModal isOpen={true} onClose={mockOnClose} />);
  ...
  it('submits form data', async () => {
    render(<EditarAdmissaoModal isOpen={true} onClose={mockOnClose} onSubmit={mockOnSubmit} />);
  ...
  it('handles loading state', () => {
    render(<EditarAdmissaoModal isOpen={true} onClose={mockOnClose} isLoading />);
