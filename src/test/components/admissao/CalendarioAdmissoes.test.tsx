...
describe('CalendarioAdmissoes', () => {
  ...
  it('renders correctly', () => {
    render(<CalendarioAdmissoes isOpen={true} onClose={mockOnClose} />);
  ...
  it('submits form data', async () => {
    render(<CalendarioAdmissoes isOpen={true} onClose={mockOnClose} onSubmit={mockOnSubmit} />);
  ...
  it('handles loading state', () => {
    render(<CalendarioAdmissoes isOpen={true} onClose={mockOnClose} isLoading />);
