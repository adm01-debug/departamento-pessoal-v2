...
import { InsalubridadeConfig } from '@/components/adicionais/InsalubridadeConfig';

describe('InsalubridadeConfig', () => {
  const mockOnSave = vi.fn();

  beforeEach(() => vi.clearAllMocks());

  it('renders form correctly', () => {
    render(<InsalubridadeConfig onSave={mockOnSave} />);
  ...
  it('loads initial data', () => {
    ...
    render(<InsalubridadeConfig onSave={mockOnSave} initialData={initialData} />);
