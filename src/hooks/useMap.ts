...
export interface useMapOptions { enabled?: boolean; debounce?: number; }
export interface useMapResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useMap<T = any>(initialValue?: T, options: useMapOptions = {}) {
