...
export interface useAuthOptions { enabled?: boolean; debounce?: number; }
export interface useAuthResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useAuth<T = any>(initialValue?: T, options: useAuthOptions = {}) {
