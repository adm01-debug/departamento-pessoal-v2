...
export interface useDialogOptions { enabled?: boolean; debounce?: number; }
export interface useDialogResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useDialog<T = any>(initialValue?: T, options: useDialogOptions = {}) {
