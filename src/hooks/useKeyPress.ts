...
export interface useKeyPressOptions { enabled?: boolean; debounce?: number; }
export interface useKeyPressResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useKeyPress<T = any>(initialValue?: T, options: useKeyPressOptions = {}) {
