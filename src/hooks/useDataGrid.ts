...
export interface useDataGridOptions { enabled?: boolean; debounce?: number; }
export interface useDataGridResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useDataGrid<T = any>(initialValue?: T, options: useDataGridOptions = {}) {
