...
export interface useFocusTrapOptions { enabled?: boolean; debounce?: number; }
export interface useFocusTrapResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useFocusTrap<T = any>(initialValue?: T, options: useFocusTrapOptions = {}) {
