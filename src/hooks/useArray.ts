...
export interface useArrayOptions { enabled?: boolean; debounce?: number; }
export interface useArrayResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useArray<T = any>(initialValue?: T, options: useArrayOptions = {}) {
