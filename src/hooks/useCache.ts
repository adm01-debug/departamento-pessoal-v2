...
export interface useCacheOptions { enabled?: boolean; debounce?: number; }
export interface useCacheResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useCache<T = any>(initialValue?: T, options: useCacheOptions = {}) {
