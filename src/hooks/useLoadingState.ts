...
export interface useLoadingStateOptions { enabled?: boolean; debounce?: number; }
export interface useLoadingStateResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useLoadingState<T = any>(initialValue?: T, options: useLoadingStateOptions = {}) {
