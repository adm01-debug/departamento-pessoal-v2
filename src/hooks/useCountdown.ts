...
export interface useCountdownOptions { enabled?: boolean; debounce?: number; }
export interface useCountdownResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useCountdown<T = any>(initialValue?: T, options: useCountdownOptions = {}) {
