...
export interface useCopyToClipboardOptions { enabled?: boolean; debounce?: number; }
export interface useCopyToClipboardResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useCopyToClipboard<T = any>(initialValue?: T, options: useCopyToClipboardOptions = {}) {
