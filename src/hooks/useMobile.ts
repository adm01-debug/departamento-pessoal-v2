...
export interface useMobileOptions { enabled?: boolean; debounce?: number; }
export interface useMobileResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useMobile<T = any>(initialValue?: T, options: useMobileOptions = {}) {
