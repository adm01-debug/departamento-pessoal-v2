...
export interface useListOptions { enabled?: boolean; debounce?: number; }
export interface useListResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useList<T = any>(initialValue?: T, options: useListOptions = {}) {
