...
export interface useHotkeysOptions { enabled?: boolean; debounce?: number; }
export interface useHotkeysResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useHotkeys<T = any>(initialValue?: T, options: useHotkeysOptions = {}) {
