...
export interface useFormOptions { enabled?: boolean; debounce?: number; }
export interface useFormResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useForm<T = any>(initialValue?: T, options: useFormOptions = {}) {
