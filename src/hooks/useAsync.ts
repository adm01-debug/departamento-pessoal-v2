...
export interface useAsyncOptions { enabled?: boolean; debounce?: number; }
export interface useAsyncResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useAsync<T = any>(initialValue?: T, options: useAsyncOptions = {}) {
