...
export interface useIdleOptions { enabled?: boolean; debounce?: number; }
export interface useIdleResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useIdle<T = any>(initialValue?: T, options: useIdleOptions = {}) {
