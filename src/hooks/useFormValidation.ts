...
export interface useFormValidationOptions { enabled?: boolean; debounce?: number; }
export interface useFormValidationResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useFormValidation<T = any>(initialValue?: T, options: useFormValidationOptions = {}) {
