...
export interface useLongPressOptions { enabled?: boolean; debounce?: number; }
export interface useLongPressResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useLongPress<T = any>(initialValue?: T, options: useLongPressOptions = {}) {
