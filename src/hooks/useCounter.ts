...
export interface useCounterOptions { enabled?: boolean; debounce?: number; }
export interface useCounterResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useCounter<T = any>(initialValue?: T, options: useCounterOptions = {}) {
