...
export interface useAssinaturasOptions { enabled?: boolean; debounce?: number; }
export interface useAssinaturasResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useAssinaturas<T = any>(initialValue?: T, options: useAssinaturasOptions = {}) {
