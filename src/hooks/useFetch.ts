...
export interface useFetchOptions { enabled?: boolean; debounce?: number; }
export interface useFetchResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useFetch<T = any>(initialValue?: T, options: useFetchOptions = {}) {
