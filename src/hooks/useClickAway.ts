...
export interface useClickAwayOptions { enabled?: boolean; debounce?: number; }
export interface useClickAwayResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useClickAway<T = any>(initialValue?: T, options: useClickAwayOptions = {}) {
