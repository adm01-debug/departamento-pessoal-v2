...
export interface useModalOptions { enabled?: boolean; debounce?: number; }
export interface useModalResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useModal<T = any>(initialValue?: T, options: useModalOptions = {}) {
