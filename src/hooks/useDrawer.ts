...
export interface useDrawerOptions { enabled?: boolean; debounce?: number; }
export interface useDrawerResult<T = any> { data: T | null; loading: boolean; error: Error | null; }

export function useDrawer<T = any>(initialValue?: T, options: useDrawerOptions = {}) {
